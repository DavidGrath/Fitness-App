        ...
        setContent {
            FitnessAppTheme {
                ...
                OnboardingScreen(
                    ...
                    setHeight = { height -> viewModel.setHeight(height)},
                    setHeightUnit = { heightUnit -> viewModel.setHeightUnit(heightUnit)},
                    setDay = { day -> viewModel.setBirthDate(day, screenState.value?.birthDateMonth?:0, screenState.value?.birthDateYear?:1984)},
                    setMonth = { month -> viewModel.setBirthDate(screenState.value?.birthDateDay?:1, month, screenState.value?.birthDateYear?:1984)},
                    setYear = { year -> viewModel.setBirthDate(screenState.value?.birthDateDay?:1, screenState.value?.birthDateMonth?:0, year)},
                    setWeight = { weight -> viewModel.setWeight(weight)},
                    setWeightUnit = { weightUnit -> viewModel.setWeightUnit(weightUnit)},
